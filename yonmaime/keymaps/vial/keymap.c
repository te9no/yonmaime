...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        LCTL_T(KC_ESC),KC_LGUI, KC_LALT,  KC_SPC, LT(1,KC_SPC),   LT(1,KC_SPC),  KC_RALT, KC_APP,  KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT,
        KC_ENT,  KC_UP,   KC_DOWN,          KC_LEFT, KC_RGHT,                                                  KC_PGDN, KC_HOME, KC_PGUP
    ),
    [1] = LAYOUT(
        ...
        KC_MUTE, KC_VOLU, KC_VOLD,          KC_TRNS, KC_TRNS,                                                  KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [2] = LAYOUT(
